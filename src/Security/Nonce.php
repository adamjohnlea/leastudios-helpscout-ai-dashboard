 ...
 *
 * @package LEAStudios\HelpScoutAIDashboard\Security
 */

declare(strict_types=1);

namespace LEAStudios\HelpScoutAIDashboard\Security;
...
final class Nonce {
	 ...
	 */
	private const PREFIX = 'leastudios_helpscout_ai_dashboard_';
